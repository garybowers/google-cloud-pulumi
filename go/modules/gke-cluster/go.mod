...
replace github.com/google-cloud-pulumi/go/utils/defaulter => ../../utils/defaulter

require (
	github.com/google-cloud-pulumi/go/utils/defaulter v0.0.0-00010101000000-000000000000
